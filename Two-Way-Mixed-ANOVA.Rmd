...
* 4 in (4, 84) - degrees of freedom for the interaction term, which is calculated as (k-1) x (r-1) where k = number of groups and r = number of repeated tests
* 84 in (4, 84) - degrees of freedom of the within-subjects residuals (error), which is calculated as (n-1)*(r-1) where n = sample size
* 107.77 - F-value (ratio of true variance/error variance)
* p < .001 - probability of obtaining the observed F-value given the null hypothesis is true.
